      ...
      items: [
        {
          ...
          capability: 'authed',
          shortcut: 'g w',
          onNavigate: () => { window.location.hash = '#/ai-workspace'; },
        },
        {
          id: 'ai_modes',
          label: 'Enterprise AI Modes',
          hash: '#/ai-modes',
          icon: Bot,
          capability: 'authed',
          shortcut: 'g m',
          onNavigate: () => { window.location.hash = '#/ai-modes'; },
        },
        {
          id: 'work_agent',
          label: 'Work Agent Center',
          hash: '#/work-agent',
          icon: Crosshair,
          capability: 'authed',
          shortcut: 'g r',
          onNavigate: () => { window.location.hash = '#/work-agent'; },
        },
        {
          id: 'enterprise_connectors',
          label: 'Connector Center',
          hash: '#/enterprise-connectors',
          icon: Plug,
          capability: 'authed',
          shortcut: 'g c',
          onNavigate: () => { window.location.hash = '#/enterprise-connectors'; },
        },
        {
          id: 'enterprise_knowledge',
          label: 'Knowledge Center',
          hash: '#/enterprise-knowledge',
          icon: BookOpen,
          capability: 'authed',
          shortcut: 'g k',
          onNavigate: () => { window.location.hash = '#/enterprise-knowledge'; },
        },
        {
          id: 'enterprise_admin',
          label: 'Administration Center',
          hash: '#/enterprise-admin',
          icon: Settings,
          capability: 'authed',
          shortcut: 'g a',
          onNavigate: () => { window.location.hash = '#/enterprise-admin'; },
        },
        {
          id: 'dashboard',
