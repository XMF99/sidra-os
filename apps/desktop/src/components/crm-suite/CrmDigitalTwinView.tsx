...
export const CrmDigitalTwinView: FC = () => {
  const { simulations, runCrmSimulation } = useCustomerIntelligenceStore();

  return (
    <Stack gap="20px" style={{ width: '100%' }}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
        <div>
          <Heading level={3}>CRM Digital Twin Sandbox ⭐</Heading>
          <Text color="secondary">
            Executes Campaign, Pipeline, Pricing, Retention, and Expansion simulations inside the isolated Digital Twin Sandbox without direct production mutations.
          </Text>
        </div>
        <Button
          variant="primary"
          leftIcon={<Icon name="Zap" size={16} />}
          onClick={() => runCrmSimulation('Campaign', 'Global Game Studio Outreach Campaign Simulation')}
        >
          ...
          >
            <Stack gap="12px">
              ...
              <div style={{ fontSize: 12, color: '#94a3b8' }}>
                ...
                <span style={{ marginLeft: 20 }}>Projected Win Rate Gain: <strong>+{sim.projectedWinRateGain}%</strong></span>
              ...
              <Alert type="info" title="Sandbox Execution Safety Certificate:">
                Verified zero direct production customer record mutations during scenario execution.
              </Alert>
            </Stack>
          </Box>
        ))}
