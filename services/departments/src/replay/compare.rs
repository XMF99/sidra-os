...
pub fn compare_canonical_briefs(v1_brief_json: &str, replayed_brief_json: &str) -> Result<(), String> {
    ...
    let fields = ["situation", "actions", "findings", "recommendation", "the_ask", "confidence"];
    for f in fields {
