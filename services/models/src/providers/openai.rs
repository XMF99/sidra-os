...
impl ModelProvider for OpenAIProvider {
    ...
    fn complete(&self, request: &CompletionRequest) -> Result<CompletionResponse, ModelError> {
        ...
        // Simulate normalized OpenAI completion response
        ...
        Ok(CompletionResponse {
            ...
            content: "Response generated by OpenAI adaptor".to_string(),
            tool_calls,
            usage: TokenUsage {
                prompt_tokens,
                completion_tokens,
                total_tokens: prompt_tokens + completion_tokens,
                estimated_cost_usd: (prompt_tokens as f64 * 0.000005) + (completion_tokens as f64 * 0.000015),
            },
