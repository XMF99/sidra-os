...
pub fn handle_unreachable(connector_id: &ConnectorId, registry: &ConnectorRegistry, _reason: &str) {
    registry.set_status(connector_id, ConnectorState::Unreachable);
}

pub fn handle_recovered(connector_id: &ConnectorId, registry: &ConnectorRegistry) {
