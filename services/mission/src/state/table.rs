...
pub fn get_transition_rules() -> Vec<TransitionRule> {
    vec![
        ...
        TransitionRule {
            ...
            trigger: "assemble_plan",
            allowed_actor: "kernel",
        },
        TransitionRule {
            from: MissionState::Planned,
            to: MissionState::Appraised,
            trigger: "appraise",
            allowed_actor: "kernel",
        },
        TransitionRule {
            from: MissionState::Appraised,
            to: MissionState::AwaitingReview,
            trigger: "submit_for_review",
            allowed_actor: "any",
        },
        TransitionRule {
            from: MissionState::AwaitingReview,
            to: MissionState::Reviewed,
            trigger: "record_review",
            allowed_actor: "any",
        },
        TransitionRule {
            from: MissionState::Reviewed,
            to: MissionState::AwaitingAuth,
            trigger: "submit_for_auth",
            allowed_actor: "any",
        },
        // Principal-Only Transitions (ARCH §4.3)
        TransitionRule {
            from: MissionState::AwaitingAuth,
            to: MissionState::Ready,
            trigger: "authorise",
            allowed_actor: "principal",
        },
        TransitionRule {
            from: MissionState::AwaitingAuth,
            to: MissionState::Abandoned,
            trigger: "abandon",
            allowed_actor: "principal",
        },
        TransitionRule {
            from: MissionState::Ready,
        ...
        TransitionRule {
            from: MissionState::Running,
            to: MissionState::PartiallyCompleted,
