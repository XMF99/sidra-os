# THEKY P08.4 — Figma Production Readiness Specs for Collaboration UI

> **Program P08.4: Collaboration & Productivity UI Production**  
> **Document:** 11-figma-production-ready.md  
...
All Collaboration & Productivity UI screens are published in production file `[PROD-02] 02-Desktop Shell UI`:

* **Auto Layout Alignment:** 100% of Task Kanban Boards, Calendar Grids, and Notes Editors use nested Auto Layout with fixed, hugging, or fill container constraints. Zero manual absolute positioning.
