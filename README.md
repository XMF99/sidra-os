...
**This repository contains the complete design of that system before implementation.** No production code is
included, by design. Every document is written to be executable by an engineering team without further
discovery.
...
| Documents | 83 markdown files — 52 in `/docs`, 29 in `/docs-v2`, plus this file and the guide |
| Decision records | 21, all accepted, none superseded |
| Words | ~92,000 |
